...
//    public void export(List<CartItem> items) throws DocumentException, MalformedURLException, IOException, URISyntaxException {
//
//        // Use iText Image (not java.awt.Image)
//        Image logo = Image.getInstance("fm.jpg");
//        logo.scaleAbsolute(50, 50);
//
//        Document document = new Document();
...
//
//        // Calculate total
//        double grandTotal = items.stream().mapToDouble(CartItem::getAmount).sum();
//
//        // Add some space
//        for (int i = 0; i < 5; i++) {
//            document.add(Chunk.NEWLINE);
...
//
//        // Total Amount
//        Chunk totalChunk = new Chunk("Total Amount: " + grandTotal, font);
...
//
//    private void addTableHeader(PdfPTable table) {
//        Stream.of("Product Name", "Quantity", "Price", "Amount")
//                .forEach(columnTitle -> {
//                    PdfPCell header = new PdfPCell();
//                    header.setBackgroundColor(BaseColor.LIGHT_GRAY);
//                    header.setBorderWidth(2);
...
public class PdfExportService {
    ...
    public void export(List<CartItem> items) throws DocumentException, MalformedURLException, IOException, BadElementException {

        // If using classpath resource, use getResource(...) — see note below
        Image logo = Image.getInstance("fm.jpg");
        logo.scaleAbsolute(50, 50);
        ...
        document.add(new Chunk("Total Amount: " + grandTotal, font));
        document.close();
    }
